...
namespace BankSimulator.DataAccess
{
    public class PersonsDal
    {
        ...
        public async Task<List<Person>>  GetAllPersons()
        {
            ...
            dataReader.Close(); return persons;
        }
        ...
        //{
        //    OpenConnection(); // Format and execute SQL statement.
        ...
        //        cmdInsert.Transaction = tx; cmdUpdate.Transaction = tx;
        //        // Execute the commands.
        //        cmdInsert.ExecuteNonQuery(); cmdUpdate.ExecuteNonQuery();
        //        // Simulate error.
        //        if (throwEx)
        //        {
